...
export class FissionAnalysis extends Component {
        ...
        return(
            <div className="container-fluid mx-1">
                ...
                <div className="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 className="h3 mb-0 text-gray-800">Data Analysis</h1>
                    <p>Time: {Date.now()}</p>
                </div>
                {/*content row*/}
                <div className="row">
                ...
                <div className="row">
                    ...
                    <div className="card shadow mb-4 col-12">
                        ...
                        <div className="card-header py-3">
                            <h6 className="m-0 font-weight-bold text-primary">Fission Visualization</h6>
                        </div>
                        {/*card body*/}
                        <div className="card-body">
                        </div>
